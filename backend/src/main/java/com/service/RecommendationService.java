...
public class RecommendationService {
    ...
    private static final double MINIMUM_COMPATIBILITY_SCORE = 20.0;
    ...
    public List<User> getRecommendations(Long userId) {
        ...
        return scoredUsers.entrySet().stream()
            .filter(entry -> entry.getValue() >= MINIMUM_COMPATIBILITY_SCORE)
    ...
    public boolean isRecommendedFor(Long userId, Long candidateId) {
        try {
    ...
    private boolean isLocationCompatible(User user1, User user2) {
        ...
        if (bio1.getLatitude() != null && bio1.getLongitude() != null
            && bio2.getLatitude() != null && bio2.getLongitude() != null
            && bio1.getMaxRadiusKm() != null) {
    ...
    private double distanceInKilometers(double latitude1, double longitude1,
